 ...
 */
final class Version20200427152155 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE file_name file_name VARCHAR(255)  NULL, CHANGE updated_at updated_at DATETIME  NULL');
    }
